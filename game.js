...
const MOBILE_TOUCH_JUMP_HOLD_TIME = 0.38;
...
const MOBILE_JUMP_MULTIPLIER = 1.07;
...
const levels = [
  ...
  },
  {
    ...
    platforms: [
      ...
      { x: 2878, y: 314, w: 168, h: 28, kind: "cloud" },
    ...
    enemies: [
      ...
      { x: 2760, y: 272, w: 34, h: 30, vx: 68, left: 2670, right: 2860, type: "drone" },
